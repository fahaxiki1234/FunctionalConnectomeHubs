...
if ~exist( [ OutputPath, filesep, 'zFCS', filesep, 'zFCS_', name, '.nii' ], 'file' )
    ...
    Mask = 'YOURPATH/BrainMask/rAAL2_WithoutCER_Mask.mat';
    Header = 'YOURPATH/BrainMask/rAAL2_WithoutCER_Mask_Header.mat';
    ...
    if DistanceMask > 0.5
        load( 'YOURPATH/BrainMask/rAAL2_WithoutCER_Mask_DistanceMask20.mat' );
