...
AxonDevelopment = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-AxonDevelopment-Hub.csv", header=None)
...
AxonDevelopment = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-AxonDevelopment-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(AxonDevelopment.loc[0].values, AxonDevelopment.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=1, color="tab:brown", linestyle='--', ci=None)


Myelination = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-Myelination-Hub.csv", header=None)
...
Myelination = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-Myelination-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(Myelination.loc[0].values, Myelination.loc[1].values, frac=0.1)
...
fig.savefig(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-3.tiff", dpi=600)
