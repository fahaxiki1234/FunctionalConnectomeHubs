...
NeuronDifferentiation = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-NeuronDifferentiation-Hub.csv", header=None)
...
NeuronDifferentiation = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-NeuronDifferentiation-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(NeuronDifferentiation.loc[0].values, NeuronDifferentiation.loc[1].values, frac=0.1)
seaborn.lineplot(x=xout, y=yout, linewidth=1, color="tab:orange", linestyle='--', ci=None)


NeuronMigration = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-NeuronMigration-Hub.csv", header=None)
...
NeuronMigration = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-NeuronMigration-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(NeuronMigration.loc[0].values, NeuronMigration.loc[1].values, frac=0.1)
...
fig.savefig(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectoryNeocortex-1.tiff", dpi=600)
