...
AG = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectory-AG-Hub.csv", header=None)
...
AG = pandas.read_csv(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectory-AG-NonHub.csv", header=None)
xout, yout, weigts = loess_1d(AG.loc[0].values, AG.loc[1].values, frac=0.1)
...
fig.savefig(r"YOURPATH\BrainSpanAtlas\DevelopmentTrajectory-AG.tiff", dpi=600)
